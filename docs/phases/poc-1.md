...
| TASK-P1-002 | AI Interop Bus 实现 | AI-Dev-001 | AI-QA-001 | TASK-P1-001 | 高 | ✅ 已完成 | TEST-P1-002 | ✅ 通过 |
| TASK-P1-003 | RPC Bridge 完善 | AI-Dev-002 | AI-QA-002 | TASK-P1-001 | 高 | ✅ 已完成 | TEST-P1-003 | ✅ 通过 |
| TASK-P1-004 | AI Session Broker 实现 | AI-Dev-001 | AI-QA-001 | TASK-P1-002 | 高 | ✅ 已完成 | TEST-P1-004 | ✅ 通过 |
| TASK-P1-005 | Permission & Policy Service 实现 | AI-Dev-003 | AI-QA-002 | TASK-P1-001 | 中 | ✅ 已完成 | TEST-P1-005 | ✅ 通过 |
| TASK-P1-006 | Audit Service 实现 | AI-Dev-003 | AI-QA-002 | TASK-P1-001 | 中 | ✅ 已完成 | TEST-P1-006 | ✅ 通过 |
| TASK-P1-007 | 端到端集成测试 | AI-Dev-002 | AI-QA-001 | TASK-P1-002, TASK-P1-003, TASK-P1-004 | 高 | ✅ 已完成 | TEST-P1-007 | ✅ 通过 |
| TASK-P1-008 | 权限弹窗 UI 实现 | AI-Dev-004 | AI-QA-003 | TASK-P1-005 | 中 | ✅ 已完成 | TEST-P1-008 | ✅ 通过 |
| TASK-P1-009 | 审计视图 UI 实现 | AI-Dev-004 | AI-QA-003 | TASK-P1-006 | 低 | ⬜ 待开始 | TEST-P1-009 | ⬜ 待验收 |
| TASK-P1-010 | 文档与示例完善 | AI-PM-001 | - | TASK-P1-007 | 低 | ⬜ 待开始 | TEST-P1-010 | ⬜ 待验收 |
| TASK-P1-011 | 核心功能单元测试 | AI-Dev-002 | AI-QA-001 | TASK-P1-002, TASK-P1-004, TASK-P1-005, TASK-P1-006 | 中 | ⬜ 待开始 | TEST-P1-011 | ⬜ 待验收 |
| TASK-P1-014 | MCP Adapter 实现 | AI-Dev-006 | AI-QA-005 | TASK-P1-002 | P0（最高） | ⬜ 待开始 | TEST-P1-014 | ⬜ 待验收 |
| TASK-P1-012 | Chat Participant Adapter 实现 | AI-Dev-005 | AI-QA-004 | TASK-P1-002 | P2（降级） | ⬜ 待开始 | TEST-P1-012 | ⬜ 待验收 |
| TASK-P1-013 | Language Model API Adapter 实现 | AI-Dev-005 | AI-QA-004 | TASK-P1-002, TASK-P1-012 | P2（降级） | ⬜ 待开始 | TEST-P1-013 | ⬜ 待验收 |
...
### 3.11 TASK-P1-012: Chat Participant Adapter 实现

**目标**: 实现零侵入式 Chat Participant 适配器
...
**验收标准**:
- GitHub Copilot Chat 自动接入 AI Interop Bus（无需修改 Copilot 代码）
...
**详细任务卡**: [TASK-P1-012.md](../tasks/poc1/TASK-P1-012.md)

---

### 3.12 TASK-P1-013: Language Model API Adapter 实现

**目标**: 实现零侵入式 Language Model API 适配器

**优先级**: 高

**实现内容**:
- 监听 Language Model 注册和变更事件
- 自动将 Language Model 包装为 AI Interop Endpoint
- 请求/响应协议转换（AI Interop ↔ Language Model API）
- 流式输出转换
- CancellationToken 传递
- 工具调用支持
...
**验收标准**:
- GitHub Copilot Language Model 自动接入 AI Interop Bus
...
**详细任务卡**: [TASK-P1-013.md](../tasks/poc1/TASK-P1-013.md)

---

### 3.13 TASK-P1-014: MCP Adapter 实现

**目标**: 实现 MCP (Model Context Protocol) Adapter

**优先级**: P0（最高优先级 - 架构关键突破）

**背景**: 根据 [主流 AI IDE 扩展研究报告](../ai-interop/14-mainstream-ai-extensions-research-report.md)，2026 年的主流 AI IDE 扩展（Codex、Claude Code）都使用 MCP 协议，市场份额 60%+。MCP Adapter 是覆盖主流 AI 扩展的关键。

**实现内容**:
- MCP 协议客户端实现（STDIO transport）
- 自动发现和连接 MCP 服务器
...
**验收标准**:
- MCP 服务器可以自动启动和连接
- MCP Tools 自动包装为 AI Interop Endpoints
- 可以通过 AI Interop Bus 调用 MCP Tools
- 协议转换正确
- Cancel 正确传递
- 错误处理完整
...
**详细任务卡**: [TASK-P1-014.md](../tasks/poc1/TASK-P1-014.md)

**重要性**: 这是适配 Codex 和 Claude Code 的关键任务，覆盖 60%+ 市场份额
...
### 阶段 4: 零侵入式适配器(Week 4) - 架构关键突破
```
TASK-P1-014 (MCP Adapter) ← P0 最高优先级，覆盖 60%+ 市场
    ↓
TASK-P1-012 (Chat Participant Adapter) ← P2 降级
    ↓
TASK-P1-013 (Language Model API Adapter) ← P2 降级
```

**重要说明**：根据 [主流 AI IDE 扩展研究报告](../ai-interop/14-mainstream-ai-extensions-research-report.md)，MCP Adapter 是适配 Codex 和 Claude Code 的关键，必须优先实现。

### 阶段 5: 完善(Week 5)
```
TASK-P1-010 (文档与示例完善)
TASK-P1-011 (核心功能单元测试)
```
...
| AI-Dev-002 | 开发 AI | TASK-P1-003, TASK-P1-007, TASK-P1-011 | - |
| AI-Dev-003 | 开发 AI | TASK-P1-005, TASK-P1-006 | - |
| AI-Dev-004 | 开发 AI | TASK-P1-008, TASK-P1-009 | - |
| AI-Dev-005 | 开发 AI | TASK-P1-012, TASK-P1-013 | - |
| AI-Dev-006 | 开发 AI | TASK-P1-014 | - |
| AI-QA-001 | 验收 AI | - | TEST-P1-001, TEST-P1-002, TEST-P1-004, TEST-P1-007, TEST-P1-011 |
| AI-QA-002 | 验收 AI | - | TEST-P1-003, TEST-P1-005, TEST-P1-006 |
| AI-QA-003 | 验收 AI | - | TEST-P1-008, TEST-P1-009 |
| AI-QA-004 | 验收 AI | - | TEST-P1-012, TEST-P1-013 |
| AI-QA-005 | 验收 AI | - | TEST-P1-014 |
...
- AI-Dev-004: 负责 UI 层
- AI-Dev-005: 负责传统对话式 AI 适配器（降级）
- AI-Dev-006: 负责 MCP Adapter（架构关键突破，最高优先级）
- AI-QA-001: 验收核心功能
- AI-QA-002: 验收 RPC 和服务层
- AI-QA-003: 验收 UI 层
- AI-QA-004: 验收传统适配器
- AI-QA-005: 验收 MCP Adapter
